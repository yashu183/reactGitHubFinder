...
const UserDetails = () => {
    ...
    const { getUserDetails, loading, getUserRepos, userDetails, repos } = githubContextObj;
                    ...
                    <div className="card w-100 d-flex flex-row flex-wrap justify-content-center">
                        ...
                        <div className="w-50">
                            <img
                                ...
                                style={{ marginLeft: 'auto', marginRight: 'auto' }}></img>
                        ...
                        <div
                            ...
                            <ul className="d-flex flex-row flex-wrap justify-content-center  mx-auto">
                                ...
                                <li className="badge badge-danger p-2" style={{ fontSize: '14px' }}>
                                    <strong>Public repos : </strong>
                                    {public_repos}
                                </li>
                                <li className="badge badge-dark p-2" style={{ fontSize: '14px' }}>
